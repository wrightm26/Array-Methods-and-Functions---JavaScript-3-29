...
class User{
    ...
    changePassword(oldPassword, newPassword) {
        ...
        } else {console.log("Your old password is incorrect. We Cannot reset your password. Please try again!")};
    };
};
...
posNum = numbers.filter((num) => num < 0);

let squareNumber = posNum.map((num) => num = (Math.abs(num))**2);
